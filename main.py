...
# obj_device.devices_to_config(self=devices_config.Cisco_IOS_Switch,all_devices=obj_make_list_of_devices,config_file_path=interface_ip_address_file,cfg="int_ip_config")
...
# obj_device.devices_to_config(self=devices_config.Cisco_IOS_Switch,all_devices=obj_make_list_of_devices,config_file_path=interface_vlan_file,cfg="int_vlan_config")
...
obj_device.devices_to_config(self=devices_config.Cisco_IOS_Switch,all_devices=obj_make_list_of_devices,config_file_path=static_route_config_file,cfg="static_route")
